package com.yun.preapisecure.dsl;

import com.yun.preapisecure.filter.RestAuthenticationFilter;
...
public class RestApiDsl<H extends HttpSecurityBuilder<H>>
    ...
    public RestApiDsl<H> restSuccessHandler(AuthenticationSuccessHandler successHandler) { this.successHandler = successHandler;
        return this;
    }
